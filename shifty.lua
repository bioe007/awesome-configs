            ...
            if a.match then
                    ...
                    if
                        ...
                        then
                            ...
                            if a.startup and startup then
                                a = awful.util.table.join(a, a.startup) end
                    ...
                    elseif #sel > 0 then
                        for i, t in ipairs(sel) do
                            ...
                            if not (awful.tag.getproperty(t, "exclusive") or
                                (mc and mc >= #t:clients())) or intrusive then
                ...
                if #target_tag_names > 0 and #target_tags == 0 then
                    ...
                    for i, tn in ipairs(target_tag_names) do
                        ...
                        if #res == 0 then
                            ...
                            target_tags = awful.util.table.join(target_tags,
                                                                res)
                        end
                    end
                end
                ...
                if #target_tags > 0 and not startup then
                    ...
                    for i, t in ipairs(target_tags) do
                        if not (awful.tag.getproperty(t, "nopopup") or
                                nopopup) then
                ...
                if config.sloppy then
                    ...
                    c:add_signal("mouse::enter", function(c)
                        if awful.layout.get(c.screen) ~=
                            awful.layout.suit.magnifier and
                        ...
                        if #clients == sticky then
                            if not awful.tag.getproperty(t, "persist") and
                                ...
                                if awful.tag.getproperty(t, "deserted") or
                                    not awful.tag.getproperty(t, "leave_kills")
                                                                        then
                                    local delay = awful.tag.getproperty(t,
                                                                "sweep_delay")
                                    if delay then
                                        local f = function()
                                                    del(t); tmr:stop()
                                    ...
                                    if awful.tag.getproperty(t, "visited") and
                                        not t.selected then
                                        awful.tag.setproperty(t, "deserted",
                                                                true)
                                    end
                                end
                            end
