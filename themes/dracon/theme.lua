...
local bright_yellow = "#f9ff87" -- "#ffffff"
...
theme.fg_normal         = "#f9ff87" -- "#ffffff"
theme.fg_blue           = "#174DCB"
theme.fg_magenta        = "#CC00CC"
theme.fg_focus          = "#f9ff87" -- "#CC00CC"
...
theme.titlebar_bg_focus                         = "#ffffff00"
-- theme.titlebar_bg_normal                        = "#3F3F3F"
theme.titlebar_bg_normal                        = "#ffffff00"
